...
namespace SharpLog
{
    ...
    public abstract class LoggerBase : ILogger
    {
        ...
        public abstract void Debug<T>(Func<T, string> textFunc, T state, string callerName = null);
        public abstract void Trace(string text, [CallerMemberName] string callerName = null);
        public abstract void Trace<T>(Func<T, string> textFunc, T state, string callerName = null);
        ...
        public abstract Task DebugAsync<T>(Func<T, string> textFunc, T state, string callerName = null);
        public abstract Task TraceAsync(string text, [CallerMemberName] string callerName = null);
        public abstract Task TraceAsync<T>(Func<T, string> textFunc, T state, string callerName = null);
